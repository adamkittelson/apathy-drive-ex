defmodule ApathyDrive.MonsterTemplate do
  ...
  def changeset(%MonsterTemplate{} = monster_template, params \\ %{}) do
    monster_template
    |> cast(params, ~w(name description death_message enter_message enter_message exit_message greeting abilities adjectives alignment level experience movement), ~w(gender game_limit chance_to_follow unities))
