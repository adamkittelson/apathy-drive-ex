defmodule ApathyDrive.Skills.MaceMastery do
  ...
  def tooltip(character, skill) do
    """
      <span style="color: lime">Mace Mastery</span>
      Increases damage, attack rating, and critical hit chance while wielding a mace.
