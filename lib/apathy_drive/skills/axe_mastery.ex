defmodule ApathyDrive.Skills.AxeMastery do
  ...
  def tooltip(character, skill) do
    """
      <span style="color: lime">Axe Mastery</span>
      Increases damage, attack rating, and critical hit chance while wielding an axe.
