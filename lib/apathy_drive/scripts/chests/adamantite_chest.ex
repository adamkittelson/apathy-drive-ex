defmodule ApathyDrive.Scripts.AdamantiteChest do
  import ApathyDrive.Scripts
  alias ApathyDrive.{Mobile, Room}

  def execute(%Room{} = room, mobile_ref, _target_ref) do
    Room.update_mobile(room, mobile_ref, fn room, mobile ->
      Mobile.send_scroll(mobile, "<p>You open the adamantite chest, and find...</p>")

      room
      |> give_coins_up_to(mobile_ref, %{gold: 300, silver: 3000})
