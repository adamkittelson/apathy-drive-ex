defmodule ApathyDrive.Scripts.GreaterDemonWeapon do
  ...
  def execute(%Room{} = room, mobile_ref, item) do
    Room.update_mobile(room, mobile_ref, fn room, mobile ->
      ...
      if demon do
        greater_demon_weapon(room, mobile, demon, item)
      else
        Mobile.send_scroll(
          mobile,
  ...
  def greater_demon_weapon(room, mobile, demon, item) do
    spellcasting =
    ...
    if :rand.uniform(100) < spellcasting - 20 do
      ...
      room =
        update_in(room.mobiles[mobile.ref], &Systems.Effect.add(&1, effect, :timer.minutes(90)))
