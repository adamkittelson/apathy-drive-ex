defmodule ApathyDrive.Commands.Cooldowns do
  ...
  def execute(%Room{} = room, %Character{} = character, _arguments) do
    Mobile.send_scroll(character, "<p><span class='white'>The following abilities are on cooldown:</span></p>")
    Mobile.send_scroll(character, "<p><span class='dark-magenta'>Ability Name    Remaining</span></p>")
