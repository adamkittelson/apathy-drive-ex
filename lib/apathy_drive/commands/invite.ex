    ...
    case Room.find_mobile_in_room(room, character, query) do
      ...
      %Monster{} = monster ->
        if Monster.hireable?(monster, character, room) do
          ...
          message = "I'd be willing to join your party, for a price. You can <span class='green'>hire</span> me for #{price} gold."
          Mobile.send_scroll(character, "<p>#{Mobile.colored_name(monster, character)} says: <span class='dark-green'>\"#{message}\"</span></p>")
        else
