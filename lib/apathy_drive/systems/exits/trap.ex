...
%{"damage" => 3.3, "destination" => 8860, "direction" => "north",
   "from_message" => "As {{user}} walks through the passage, slicing blades sweep out to strike them!",
   "kind" => "Trap",
   "mover_message" => "As you walk through the passage, blades sweep out and slice you!",
   "to_message" => "{{User}} walks through the passage, bleeding heavily from deep cuts!"}