  ...
  def execute(_spirit, monster, arguments) do
    ...
    if Enum.any? arguments do
      ...
      case room_exit do
        ...
        %{"kind" => "Door"} ->
          Systems.Exits.Door.close(monster, current_room, room_exit)
        %{"kind" => "Gate"} ->
          Systems.Exits.Gate.close(monster, current_room, room_exit)
        %{"kind" => "Key"} ->
          Systems.Exits.Key.close(monster, current_room, room_exit)
        _ ->
